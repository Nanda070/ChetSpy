...
Документация закрывает все вопросы по развертыванию, от установки либ до маршрутизации редиректов. Если готовы выводить на Oracle — разворачивай там окружение по этому же мануалу.
